package com.ardi.apppenyimpananktp.UILogin;
...
import com.ardi.apppenyimpananktp.R;
            ...
            mAuth.getCurrentUser().reload().addOnSuccessListener(new OnSuccessListener<Void>() {
                ...
                public void onSuccess(Void aVoid) {
                    ...
                    if (currentUser != null && currentUser.isEmailVerified()) {
                        ...
                        Intent MainActivity = new Intent(WelcomeActivity.this, com.ardi.apppenyimpananktp.MainActivity.class);
